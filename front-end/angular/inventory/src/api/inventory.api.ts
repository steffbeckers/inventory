...
export class ItemDto implements IItemDto {
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.purchaseDate = _data['purchaseDate']
        ? moment.parseZone(_data['purchaseDate'].toString())
        : <any>undefined;
      this.purchasePrice = _data['purchasePrice'];
      this.expirationDate = _data['expirationDate']
        ? moment.parseZone(_data['expirationDate'].toString())
        : <any>undefined;
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data['purchaseDate'] = this.purchaseDate
      ? this.purchaseDate.toISOString(true)
      : <any>undefined;
    data['purchasePrice'] = this.purchasePrice;
    data['expirationDate'] = this.expirationDate
      ? this.expirationDate.toISOString(true)
      : <any>undefined;
    return data;
  }
}
  ...
  init(_data?: any) {
    if (_data) {
      this.date = _data['date']
        ? moment.parseZone(_data['date'].toString())
        : <any>undefined;
