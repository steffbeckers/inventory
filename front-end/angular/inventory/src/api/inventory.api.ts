...
export class ItemsService implements IItemsService {
    ...
    createItem(createItemDto: CreateItemDto): Observable<string> {
        ...
        const content_ = JSON.stringify(createItemDto);
...
export interface ITodoItemsService {
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["infos"])) {
                ...
                for (let item of _data["infos"])
                    this.infos!.push(ItemInfoDto.fromJS(item));
            }
        }
    }
...
export class ItemInfoDto implements IItemInfoDto {
    id?: string;
    ...
    static fromJS(data: any): ItemInfoDto {
        data = typeof data === 'object' ? data : {};
        let result = new ItemInfoDto();
        result.init(data);
        return result;
    }
